...
@push('styles')
    @guest
        <style>
            ...
            /* ============================================
               NAVBAR – TRANSPARAN DI LANDING PAGE
            ============================================ */
            .nav-blur {
            ...
            .nav-blur.scrolled {
                background: linear-gradient(135deg, rgba(7, 29, 51, 0.88) 0%, rgba(13, 50, 78, 0.84) 100%) !important;
                backdrop-filter: blur(28px) saturate(165%) !important;
                -webkit-backdrop-filter: blur(28px) saturate(165%) !important;
                border-bottom: 1px solid rgba(186, 230, 253, 0.25) !important;
            }

            /* Sembunyikan inner gradient overlay navbar saat belum scroll */
            nav.nav-blur:not(.scrolled)>div:first-child {
                opacity: 0 !important;
            }
            ...
            .reveal-up.exit-up {
                ...
                transition: opacity .5s cubic-bezier(.4, 0, .6, 1), transform .5s cubic-bezier(.4, 0, .6, 1) !important;
            }
            ...
            .hero-badge-anim {
                animation: heroBadgeIn .7s cubic-bezier(.22, 1, .36, 1) .2s both;
            }

            .hero-title-anim {
                animation: heroSlideIn .8s cubic-bezier(.22, 1, .36, 1) .35s both;
            }

            .hero-sub-anim {
                animation: heroSlideIn .8s cubic-bezier(.22, 1, .36, 1) .5s both;
            }

            .hero-btn-anim {
                animation: heroSlideIn .8s cubic-bezier(.22, 1, .36, 1) .65s both;
            }

            .hero-trust-anim {
                animation: heroSlideIn .8s cubic-bezier(.22, 1, .36, 1) .8s both;
            }

            .hero-card-anim {
                animation: heroSlideIn .9s cubic-bezier(.22, 1, .36, 1) .6s both;
            }
            ...
            .stats-card {
                animation: statsPop .65s cubic-bezier(.22, 1, .36, 1) both;
            }
            ...
            @keyframes numGlow {
                ...
                50% {
                    text-shadow: 0 0 28px currentColor, 0 0 50px currentColor;
                }
            }
            ...
            @keyframes fishSwim {
                ...
                25% {
                    transform: translateX(12px) translateY(-8px) rotate(0deg) scaleX(1);
                }

                50% {
                    transform: translateX(22px) translateY(-4px) rotate(5deg) scaleX(1);
                }

                75% {
                    transform: translateX(12px) translateY(6px) rotate(0deg) scaleX(1);
                }
            ...
            .fish-deco-2 {
                animation: fishSwim2 8s ease-in-out infinite;
            }

            .fish-deco-3 {
                animation: fishSwim 9s ease-in-out infinite 1.5s;
            }
            ...
            @keyframes waveMorph {
                ...
                0%,
                100% {
                    d: path("M0 120L60 110C120 100 240 80 360 75C480 70 600 80 720 85C840 90 960 90 1080 85C1200 80 1320 70 1380 65L1440 60V120H0Z");
                }

                50% {
                    d: path("M0 90L60 100C120 110 240 90 360 80C480 70 600 95 720 90C840 85 960 75 1080 80C1200 85 1320 95 1380 85L1440 80V120H0Z");
                }
            }
            ...
            .section-badge:hover {
                animation: badgeWobble .5s ease-in-out;
            }
            ...
            .step-circle:hover {
                animation: stepBounce .6s cubic-bezier(.22, 1, .36, 1);
            }
...
@section('content')
    @guest
        ...
        <div class="fixed inset-0 w-full h-full bg-gradient-to-br from-ocean-900/70 via-ocean-800/60 to-cyan-900/70"
            style="z-index: -1;"></div>
        ...
        animation: shimmer 10s infinite linear;">
                ...
                <div class="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                    ...
                    <div class="text-center lg:text-left">
                        <div class="hero-badge-anim inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full mb-5 sm:mb-6"
                            ...
                            <div class="w-2 h-2 rounded-full bg-amber-400 animate-pulse shadow-[0_0_10px_rgba(251,191,36,0.7)]">
                            </div>
                            <span class="text-white font-semibold text-xs sm:text-sm drop-shadow-lg hero-text-xs">Platform Jual
                                Beli Ikan #1 di Tapos</span>
                        </div>

                        <h1
                            class="hero-title-anim text-3xl xs:text-4xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold leading-[1.1] mb-5 sm:mb-6">
                            <span class="text-white drop-shadow-[0_4px_20px_rgba(0,0,0,0.9)]">Ikan Segar</span>
                            <span
                                class="block mt-1 sm:mt-2 bg-gradient-to-r from-amber-300 via-yellow-200 to-amber-100 bg-clip-text text-transparent drop-shadow-[0_4px_25px_rgba(251,191,36,0.6)]">
                                Langsung dari Kolam
                            </span>
                        </h1>

                        <p
                            class="hero-sub-anim text-sm sm:text-base md:text-lg lg:text-xl text-white/95 mb-7 sm:mb-8 max-w-2xl lg:max-w-none mx-auto lg:mx-0 leading-relaxed drop-shadow-[0_2px_10px_rgba(0,0,0,0.8)]">
                            Dapatkan <strong class="text-amber-200">Ikan Nila & Ikan Mas</strong> segar berkualitas premium
                            dengan harga terbaik. Tanpa perantara!
                        </p>

                        {{-- CTA Buttons --}}
                        <div
                            class="hero-btn-anim flex flex-col xs:flex-row sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start mb-8 sm:mb-10 cta-flex-wrap">
                            <a href="{{ route('register') }}"
                                class="btn-shine-wrap btn-shiny group inline-flex items-center justify-center gap-2 sm:gap-3 px-5 sm:px-8 py-3 sm:py-4 font-bold rounded-2xl transition-all duration-300 hover:scale-105 text-sm sm:text-base hero-btn-xs"
                                ...
                                <i
                                    class="fas fa-arrow-right group-hover:translate-x-1 transition-transform hidden sm:inline"></i>
                            </a>
                            <a href="{{ route('catalog') }}"
                                class="inline-flex items-center justify-center gap-2 px-5 sm:px-8 py-3 sm:py-4 font-semibold text-white rounded-2xl transition-all duration-300 hover:bg-white/30 text-sm sm:text-base hero-btn-xs"
                        ...
                        <div
                            class="hero-trust-anim flex flex-wrap items-center gap-4 sm:gap-5 justify-center lg:justify-start trust-wrap">
                            <div class="flex items-center gap-1.5 sm:gap-2 text-white text-xs sm:text-sm whitespace-nowrap">
                                <div
                                    class="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-white/25 backdrop-blur-md flex items-center justify-center border border-white/40 shadow-lg flex-shrink-0">
                    ...
                    <div class="w-full hero-card-anim">
                        <div class="relative">
                            {{-- Glow Effect --}}
                            <div
                                class="absolute -inset-2 sm:-inset-4 bg-gradient-to-r from-amber-400/25 to-cyan-400/25 rounded-3xl blur-2xl">
                            </div>
                            ...
                            <div class="relative rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 overflow-hidden"
                                ...
                                <div class="grid grid-cols-2 gap-3 sm:gap-4 stats-grid-mobile">
                                    <div class="stats-card text-center p-3 sm:p-4 md:p-5 rounded-xl sm:rounded-2xl"
                                        ...
                                        <p class="text-white/95 text-xs sm:text-sm drop-shadow-md font-medium">Produk Tersedia
                                        </p>
                                    </div>
                                    <div class="stats-card text-center p-3 sm:p-4 md:p-5 rounded-xl sm:rounded-2xl"
                                        style="background: rgba(255,255,255,0.15); border: 1px solid rgba(255,255,255,0.2); backdrop-filter: blur(10px);">
                                        <div
                                            class="stat-number text-2xl sm:text-3xl md:text-4xl font-extrabold text-cyan-300 mb-1 drop-shadow-[0_2px_15px_rgba(34,211,238,0.6)]">
                                            100%</div>
                                        <p class="text-white/95 text-xs sm:text-sm drop-shadow-md font-medium">Segar Terjamin
                                        </p>
                                    </div>
                                    <div class="stats-card text-center p-3 sm:p-4 md:p-5 rounded-xl sm:rounded-2xl"
                                        style="background: rgba(255,255,255,0.15); border: 1px solid rgba(255,255,255,0.2); backdrop-filter: blur(10px);">
                                        <div
                                            class="stat-number text-2xl sm:text-3xl md:text-4xl font-extrabold text-amber-300 mb-1 drop-shadow-[0_2px_15px_rgba(251,191,36,0.6)]">
                                            24h</div>
                                        <p class="text-white/95 text-xs sm:text-sm drop-shadow-md font-medium">Pengiriman Cepat
                                        </p>
                                    </div>
                                    <div class="stats-card text-center p-3 sm:p-4 md:p-5 rounded-xl sm:rounded-2xl"
                                        style="background: rgba(255,255,255,0.15); border: 1px solid rgba(255,255,255,0.2); backdrop-filter: blur(10px);">
                                        <div
                                            class="stat-number text-2xl sm:text-3xl md:text-4xl font-extrabold text-cyan-300 mb-1 drop-shadow-[0_2px_15px_rgba(34,211,238,0.6)]">
                                            5.0</div>
                                        <p class="text-white/95 text-xs sm:text-sm drop-shadow-md font-medium">Rating Pelanggan
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div
                                    class="absolute -bottom-4 -right-4 text-white/5 text-7xl sm:text-9xl hidden sm:block pointer-events-none fish-deco-1">
                                    <i class="fas fa-fish"></i>
                                </div>
                            </div>
                        </div>
            ...
            <div class="absolute bottom-0 left-0 right-0">
                <svg viewBox="0 0 1440 80" preserveAspectRatio="none" fill="none" xmlns="http://www.w3.org/2000/svg"
                    class="w-full h-auto" style="height:50px;display:block;">
                    <path
                        d="M0 80L60 73C120 67 240 53 360 50C480 47 600 53 720 57C840 60 960 60 1080 57C1200 53 1320 47 1380 43L1440 40V80H0Z"
                        fill="rgba(12,74,110,0.15)" />
                    <path d="M0 80L80 68C160 56 320 32 480 29C640 26 800 44 960 50C1120 56 1280 50 1360 47L1440 44V80H0Z"
                        fill="rgba(8,145,178,0.12)" style="animation: waveMorph 8s ease-in-out infinite;" />
                </svg>
            </div>
        </section>
        ...
        <section class="py-12 sm:py-16 md:py-20 lg:py-24 relative overflow-hidden">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-10 sm:mb-14 reveal-up">
                    <div class="section-badge inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs sm:text-sm font-semibold mb-4"
                    ...
                    <p class="text-white/60 text-sm sm:text-base md:text-lg max-w-2xl mx-auto leading-relaxed px-4">
                        Platform e-commerce yang menghubungkan konsumen langsung dengan petani ikan lokal melalui sistem
                        pemesanan online yang mudah dan transparan.
                    </p>
                </div>
                ...
                <div class="grid md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
                    ...
                    <div class="reveal-left card-hover-magic relative rounded-2xl sm:rounded-3xl p-6 sm:p-8 overflow-hidden group"
                        ...
                        <div
                            class="absolute top-0 right-0 w-48 h-48 sm:w-64 sm:h-64 bg-teal-400/20 rounded-full blur-3xl group-hover:scale-150 transition-transform duration-700">
                        </div>
                        <div class="relative">
                            ...
                            <p class="text-ocean-100 text-sm sm:text-base leading-relaxed">
                                Memberikan akses mudah kepada masyarakat untuk mendapatkan ikan segar berkualitas tinggi dengan
                                harga adil, sekaligus memberdayakan petani ikan lokal melalui platform digital.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-3 sm:space-y-4">
                        <div
                            class="reveal-right reveal-d1 card-glass card-hover-magic rounded-xl sm:rounded-2xl p-4 sm:p-5 flex items-start gap-3 sm:gap-4 group">
                            ...
                            <div>
                                ...
                                <p class="text-white/50 text-xs sm:text-sm">Tanpa perantara, harga lebih murah dan petani
                                    mendapat keuntungan lebih baik.</p>
                            </div>
                        </div>
                        <div
                            class="reveal-right reveal-d2 card-glass card-hover-magic rounded-xl sm:rounded-2xl p-4 sm:p-5 flex items-start gap-3 sm:gap-4 group">
                            <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-lg sm:rounded-xl flex items-center justify-center flex-shrink-0"
                            ...
                            <div>
                                ...
                                <p class="text-white/50 text-xs sm:text-sm">Setiap ikan dipilih dengan standar tinggi dan
                                    dijamin kesegarannya.</p>
                            </div>
                        </div>
                        <div
                            class="reveal-right reveal-d3 card-glass card-hover-magic rounded-xl sm:rounded-2xl p-4 sm:p-5 flex items-start gap-3 sm:gap-4 group">
                            <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-lg sm:rounded-xl flex items-center justify-center flex-shrink-0"
                            ...
                            <div>
                                ...
                                <p class="text-white/50 text-xs sm:text-sm">Pesan online, bayar, dan ikan segar langsung
                                    dikirim ke rumah Anda.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="py-12 sm:py-16 md:py-20 relative overflow-hidden">
            <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-10 sm:mb-14 reveal-up">
                    <div class="section-badge inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs sm:text-sm font-semibold mb-4"
                        style="background: rgba(255,255,255,0.08); color: #67e8f9; border: 1px solid rgba(255,255,255,0.15);">
                        <i class="fas fa-star"></i> Keunggulan
                    </div>
                    <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-3 sm:mb-4 px-4">Kenapa Memilih
                        FishMarket?</h2>
                    <p class="text-white/60 text-sm sm:text-base md:text-lg max-w-xl mx-auto px-4">Pengalaman belanja ikan yang
                        berbeda dan lebih baik</p>
                </div>

                <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                    @foreach ([['icon' => 'fa-truck-fast', 'title' => 'Pengiriman Same-Day', 'desc' => 'Pesan pagi, sore sudah sampai. Langsung dari kolam ke dapur dalam hitungan jam.', 'gradient' => 'from-ocean-500 to-ocean-600', 'glow' => 'ocean'], ['icon' => 'fa-certificate', 'title' => 'Garansi Segar 100%', 'desc' => 'Tidak segar? Uang kembali! Kami jamin setiap ikan dalam kondisi prima.', 'gradient' => 'from-teal-500 to-mint-500', 'glow' => 'teal'], ['icon' => 'fa-tags', 'title' => 'Harga Transparan', 'desc' => 'Harga langsung dari petani, tanpa markup berlebihan. Hemat hingga 30%.', 'gradient' => 'from-coral-500 to-coral-400', 'glow' => 'coral']] as $i => $feature)
                        <div
                            class="reveal-scale reveal-d{{ $i + 1 }} card-elevated card-hover-magic rounded-2xl sm:rounded-3xl p-6 sm:p-8 text-center group">
        ...
        <section class="py-12 sm:py-16 md:py-20 lg:py-24">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-10 sm:mb-14 reveal-up">
                    ...
                    <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-3 sm:mb-4 px-4">Mudah & Cepat, Hanya 3
                        Langkah!</h2>
                </div>

                <div class="grid md:grid-cols-3 gap-6 sm:gap-8 relative">
                    {{-- Connection Line (hidden on mobile) --}}
                    <div class="hidden sm:block absolute top-1/3 left-1/4 right-1/4 h-0.5"
                        style="background: linear-gradient(to right, rgba(6,182,212,0.3), rgba(20,184,166,0.3), rgba(251,113,133,0.3));">
                    </div>

                    @foreach ([['num' => '1', 'title' => 'Daftar & Pilih Ikan', 'desc' => 'Buat akun gratis, lalu pilih ikan segar dari katalog kami.', 'gradient' => 'from-ocean-500 to-ocean-600'], ['num' => '2', 'title' => 'Pesan & Bayar', 'desc' => 'Masukkan jumlah (dalam Kg), checkout, dan tunggu konfirmasi.', 'gradient' => 'from-teal-500 to-mint-500'], ['num' => '3', 'title' => 'Terima Ikan Segar', 'desc' => 'Ikan langsung dikirim dari kolam ke alamat Anda. Segar!', 'gradient' => 'from-coral-500 to-coral-400']] as $i => $step)
        ...
        radial-gradient(circle at 70% 70%, rgba(34, 211, 238, 0.35) 0%, transparent 45%);">
            ...
            <div class="absolute inset-0 overflow-hidden">
                <div
                    class="absolute top-0 left-1/4 w-[300px] h-[300px] sm:w-[450px] sm:h-[450px] bg-gradient-to-br from-teal-400/35 to-transparent rounded-full blur-[80px] sm:blur-[100px] animate-float">
                </div>
                <div class="absolute bottom-0 right-1/3 w-[350px] h-[350px] sm:w-[500px] sm:h-[500px] bg-gradient-to-tl from-ocean-300/30 via-cyan-300/20 to-transparent rounded-full blur-[90px] sm:blur-[110px] animate-float"
                    style="animation-delay: -2s;"></div>
                <div class="absolute top-1/3 right-1/4 w-[280px] h-[280px] sm:w-[400px] sm:h-[400px] bg-gradient-to-tr from-cyan-400/25 to-transparent rounded-full blur-[70px] sm:blur-[90px] animate-float"
        ...
        animation: shimmer 8s infinite linear;">
            ...
            <div class="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center reveal-up">
                ...
                <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-3 sm:mb-4 px-4">Siap Belanja Ikan Segar?
                </h2>
                ...
                <div class="flex flex-col md:flex-row gap-4 justify-center">
                    <a href="{{ route('register') }}"
                        class="btn-shine-wrap btn-shiny inline-flex items-center justify-center gap-3 px-6 sm:px-8 py-3 sm:py-4 font-bold text-ocean-900 rounded-2xl transition-all duration-300 hover:scale-105 text-sm sm:text-base"
                    ...
                    <a href="{{ route('login') }}"
                        class="inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-4 font-semibold text-white rounded-2xl transition-all text-sm sm:text-base hover:bg-white/25"
        ...
        @push('scripts')
            @guest
                        ...
                        document.querySelectorAll('.stats-card').forEach(card => {
                            card.addEventListener('mousemove', (e) => {
                                ...
                                card.style.transform =
                                    `perspective(400px) rotateY(${x*12}deg) rotateX(${-y*12}deg) scale(1.03)`;
                            });
                ...
                pointer-events:none;
            `;
                                if (getComputedStyle(btn).position === 'static') btn.style.position =
                                'relative';
    ...
    @else
     ...
     ======================================== --}}
        ...
        <section class="relative overflow-hidden -mt-[1px]">
            {{-- Background sama persis seperti footer: cyan-950 → sky-900 → teal-950 --}}
            <div class="absolute inset-0" style="background: linear-gradient(135deg, #083344 0%, #0c4a6e 50%, #042f2e 100%);">
            </div>

            {{-- Subtle glow effects --}}
            <div class="absolute inset-0"
                style="background:
        radial-gradient(circle at 75% 50%, rgba(45, 212, 191, 0.15) 0%, transparent 50%),
        radial-gradient(circle at 15% 50%, rgba(6, 182, 212, 0.12) 0%, transparent 50%);">
            ...
            <div class="absolute inset-0 overflow-hidden">
                <div
                    class="absolute -top-10 -right-10 w-[350px] h-[350px] bg-gradient-to-br from-teal-400/15 to-transparent rounded-full blur-[80px] animate-float">
                </div>
                <div class="absolute -bottom-10 -left-10 w-[400px] h-[400px] bg-gradient-to-tl from-cyan-400/10 to-transparent rounded-full blur-[90px] animate-float"
            ...
            <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 md:py-10">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
                    ...
                    <a href="{{ route('my.orders') }}"
                        class="inline-flex items-center justify-center gap-2 px-4 sm:px-5 py-2.5 sm:py-3 rounded-xl font-semibold text-white transition-all hover:bg-white/20 text-sm sm:text-base"
        ...
        <section class="py-8 sm:py-10 md:py-12">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            ...
                            @foreach ($banners->take(4) as $banner)
                                <a href="{{ $banner->link_url ?? route('catalog') }}"
                                    ...
                                    <div class="absolute bottom-0 left-0 right-0 p-4 sm:p-5">
                                        <h3 class="text-white font-bold text-sm sm:text-lg drop-shadow-lg">
                                            {{ $banner->title }}</h3>
                                        @if ($banner->description)
                                            <p class="text-white/80 text-xs sm:text-sm mt-1 drop-shadow-md">
                ...
                <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-2 sm:gap-4 mb-6 sm:mb-8">
                    <div>
                        <p class="text-cyan-300/70 text-xs sm:text-sm font-semibold uppercase tracking-widest mb-1">Pilihan
                            Terbaik Hari Ini</p>
                        <h2 class="text-xl sm:text-2xl md:text-3xl font-extrabold text-white leading-tight">Produk Segar Hari
                            Ini</h2>
                        <p class="text-white/40 text-xs sm:text-sm mt-1">Langsung dari kolam, segar untuk meja makan Anda</p>
                    </div>
                    <a href="{{ route('catalog') }}"
                        class="hidden sm:inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold text-cyan-300 hover:text-white hover:bg-white/10 border border-cyan-400/20 hover:border-cyan-300/40 transition-all duration-200">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-4 md:gap-5">
                        @foreach ($produks->take(8) as $index => $produk)
                            ...
                            <div class="product-card"
                                style="animation: cardFadeUp .5s cubic-bezier(.22,1,.36,1) {{ $index * 0.07 }}s both;">
                                ...
                                <div class="product-img-wrap">
                                    ...
                                    @else
                                        <div
                                            class="w-full h-full flex items-center justify-center bg-gradient-to-br from-cyan-900/40 to-teal-900/40">
                                            <i class="fas fa-fish text-white/15 text-5xl sm:text-6xl"></i>
                                        </div>
                                    @endif

                                    {{-- Wishlist button --}}
                                    <div class="absolute top-2 right-2 z-10" x-data="{{ json_encode(['wishlisted' => in_array($produk->id, $wishlistedIds ?? []), 'loading' => false]) }}" x-init="wishlisted = {{ in_array($produk->id, $wishlistedIds ?? []) ? 'true' : 'false' }}">
                                        <button
                                            @click.prevent="
                                if (loading) return;
                                loading = true;
                                ...
                                .catch(() => loading = false);"
                                    ...
                                    <div class="stock-chip">
                                        ...
                                        <span :class="{{ $stokLow ? 'true' : 'false' }} ? 'text-orange-300' : ''"
                                            ...
                                            @if ($stokLow)
                                                <span class="ml-0.5 text-orange-300">●</span>
                                            @endif
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="product-body">
                                    ...
                                    {{-- Product name --}}
                                    <h3
                                        class="font-bold text-white text-sm sm:text-[.95rem] leading-snug line-clamp-2 min-h-[2.4em]">
                                        {{ $produk->nama }}
                                    </h3>
                                    ...
                                    <div class="flex items-end justify-between gap-1">
                                        <div>
                                            <p class="product-price">Rp
                                                {{ number_format($produk->harga_per_kg, 0, ',', '.') }}</p>
                                            <span class="text-[.68rem] text-white/35 font-normal leading-none">per
                                                kilogram</span>
                                        </div>
                                    </div>
                ...
                <div class="text-center mt-7 sm:hidden">
                    <a href="{{ route('catalog') }}"
                        class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-bold text-white border border-white/20 hover:bg-white/10 transition-all">
        ...
        <section class="py-5 sm:py-6 md:py-8">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-3 gap-2 sm:gap-3 md:gap-4">
                    @foreach ([['icon' => 'fa-truck', 'title' => 'Same-Day', 'desc' => 'Pesan pagi, sore sampai', 'color' => 'from-cyan-500 to-sky-600'], ['icon' => 'fa-shield-halved', 'title' => 'Garansi Segar', 'desc' => '100% uang kembali', 'color' => 'from-emerald-500 to-teal-600'], ['icon' => 'fa-hand-holding-dollar', 'title' => 'Harga Petani', 'desc' => 'Langsung dari kolam', 'color' => 'from-amber-500 to-orange-500']] as $b)
                        <div class="group flex flex-col items-center text-center p-3 sm:p-4 md:p-5 rounded-xl sm:rounded-2xl transition-all duration-300 hover:scale-[1.03]"
                            ...
                            <div
                                class="w-9 h-9 sm:w-11 sm:h-11 md:w-13 md:h-13 rounded-lg sm:rounded-xl flex items-center justify-center mb-2 sm:mb-3 bg-gradient-to-br {{ $b['color'] }} shadow-lg">
