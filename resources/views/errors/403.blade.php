...
<head>
    ...
    <title>403 - Akses Ditolak | FishMarket</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .error-icon {
            ...
            display: flex; align-items: center; justify-content: center;
            background: rgba(251,146,60,0.15); backdrop-filter: blur(20px);
            border: 1px solid rgba(251,146,60,0.3);
            box-shadow: 0 20px 50px rgba(0,0,0,0.3);
            animation: shake 3s ease-in-out infinite;
        }
        .error-icon i { font-size: 3rem; color: #fdba74; }
        .error-code {
            font-size: clamp(4rem, 12vw, 7rem); font-weight: 800; line-height: 1;
            background: linear-gradient(135deg, #fdba74, #fb923c, #fdba74);
...
<body>
    ...
    <div class="container">
        ...
        <h1>Akses Ditolak</h1>
        <p>Kamu tidak memiliki izin untuk mengakses halaman ini. Jika merasa ini adalah kesalahan, hubungi admin.</p>
