...
<head>
    ...
    <title>404 - Halaman Tidak Ditemukan | FishMarket</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .error-icon i { font-size: 3rem; color: #67e8f9; }
        .error-code {
            font-size: clamp(4rem, 12vw, 7rem); font-weight: 800; line-height: 1;
            background: linear-gradient(135deg, #67e8f9, #2dd4bf, #67e8f9);
...
<body>
    ...
    <div class="container">
        ...
        <h1>Ikan-nya Berenang Jauh...</h1>
        <p>Halaman yang kamu cari tidak ditemukan. Mungkin sudah dipindahkan atau link-nya salah. Yuk kembali ke beranda!</p>
